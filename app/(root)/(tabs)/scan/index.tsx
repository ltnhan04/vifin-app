...
const ScanScreen = () => {
  ...
  return (
    <SafeAreaView style={androidSafeArea.androidSafeArea}>
      <LinearGradient colors={["#081657", "#316F95"]} className="flex-1">
        <ScrollView
          style={{ flex: 1 }}
