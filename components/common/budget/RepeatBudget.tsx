...
const RepeatBudget = ({ control }: { control: Control<BudgetType> }) => {
  return (
    <View className="flex flex-row items-center justify-between border-b border-secondary-gray-100 py-2.5">
      <View>
        <Text className="font-rubik-semibold text-base text-white">
          Repeat this budget
        </Text>
        <Text className="font-rubik-medium text-xs text-secondary-gray-100">
