module.exports = {
  ...
  moduleNameMapper: {
    ...
    '^react-native/Libraries/Animated/src/NativeAnimatedHelper$': '<rootDir>/__mocks__/NativeAnimatedHelper.js',
    ...
    '^@react-native-firebase/auth$': '<rootDir>/__mocks__/@react-native-firebase/auth.js',
     ...
     "^react-native-radio-buttons-group$": "<rootDir>/__mocks__/react-native-radio-buttons-group.js",
